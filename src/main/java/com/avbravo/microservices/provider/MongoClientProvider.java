 ...
 */
package com.avbravo.microservices.provider;
...
public class MongoClientProvider {
    ...
    public void init() {
        try {
//           String database="spard";
//            String username="avbravo"; 
//            String password="denver";
...
//             mongoClient = new MongoClient(serverAddress, new ArrayList<>());
